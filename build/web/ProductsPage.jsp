                ...
                <div class="row">
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <%      if (isMax == true) {
                                    for (int item = 12 * (currentPages - 1); item < devicesList.size(); item++) {
                        ...
                        <div class="store-filter clearfix">
                            ...
                            <%                                int max = 0;
                                ...
                                if (currentPages == pages) {
                                    max = currentPages * 12 - 12 + remain;
                                }
                            %>
                            <span class="store-qty">Showing <%=12 * (currentPages - 1) + 1%> - <%=max%> products</span>
